...
export default class Accordion extends React.Component {
  ...
  componentDidMount() {
    strap.setAccordion(this, {
      [`${this.props.title}-${this.uniqueId}`]: React.createElement("div", null, this.props.children)
    }, {
  ...
  render() {
    const expandableElement = React.createElement(this.props.triggeringElement, {
    ...
    return React.createElement("div", {
      id: this.uniqueId
    }, expandableElement, React.createElement("div", {
      id: `content-${this.uniqueId}`
    }));
  }
