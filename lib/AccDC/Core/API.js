...
import ReactDOM from "react-dom"; // AccDC leverages the following import dependancies
// https://www.npmjs.com/package/react-html-parser

import ReactHtmlParser, { processNodes, convertNodeToElement, htmlparser2 } from "react-html-parser"; // https://www.npmjs.com/package/bean

import bean from "bean"; // https://www.npmjs.com/package/current-device

import device from "current-device"; // https://github.com/bitinn/node-fetch

import fetch from "node-fetch"; // Import the latest W3C accessible name computation algorithm code for the AccName Prototype
// https://github.com/whatsock/w3c-alternative-text-computation

require("./recursion.js");

export function $AccDC() {
  return window.AccDC || function () {
    var accDCVersion = "4.2019.0.2",
      ...
      if (!arguments.length && this === $A) {
        ...
        return $A;
      } else if (dc && $A.isArray(dc) && dc.length && dc[0] && typeof dc[0] === "object" && dc[0].id && !dc[0].nodeType) {
        disableAsync = onReady;
        onReady = dcI;
        dcI = dcA;
        dcA = dc;
        dc = null;
      } else if ((dc && $A.isDC(dc) || $A.reg.has(dc)) && dcA && $A.isArray(dcA) && dcA.length && dcA[0] && typeof dcA[0] === "object" && dcA[0].id && !dcA[0].nodeType) {
        ...
        if (this && typeof this === "string") {
          ...
          dcI = dcA;
          dcA = this === window || typeof this === "object" && "querySelectorAll" in this ? this : document;
        }

        if (typeof dc === "string") {
          var t = dc;
          if ($A.isHTML(t)) t = $A.toNode(t);else t = $A.query(t, dcA, dcI)[0];
          if (t) dc = t;
        }
      ...
      var fn = function () {
        ...
        if ($A._lastCreatedCallback && typeof $A._lastCreatedCallback === "function") $A._lastCreatedCallback.call($A, w);
      ...
      for (; i < length; i++) {
        if ((options = arguments[i]) !== null) {
          for (name in options) {
            ...
            if (deep && copy && ($A.isPlainObject(copy) || (copyIsArray = $A.isArray(copy)))) {
              if (copyIsArray) {
                copyIsArray = false;
    ...
    $A.isPlainObject = function (obj) {
      ...
      if (!obj || typeof obj !== "object" || obj.nodeType || "setInterval" in obj) {
        return false;
      }
    ...
    $A.extend({
      ...
      toDC: function (o, sett) {
        ...
        var isDOMNode = o && o.nodeType === 1 ? true : false,
            hasParent = isDOMNode && o.parentNode && o.parentNode.nodeType === 1 ? true : false,
      ...
      _storeNodes: function (f, elementOnly) {
        if (f.nodeType === 11) {
          var nl = [];
          $A.loop(f.childNodes, function (i, o) {
      ...
      toNode: function (s, elementOnly) {
        ...
        if (typeof s === "string") {
          try {
            s = $A._storeNodes(document.createRange().createContextualFragment(s), elementOnly);
          } catch (e) {
      ...
      toReact: function (o) {
        ...
        if (ReactDOM && ReactHtmlParser && o && !$A.isReact(o) && (typeof o === "string" || o.nodeType)) {
          if (o && o.nodeType === 11) {
            o = $A._checkStoredNodes(o, true);
          }

          o = ReactHtmlParser(o && typeof o === "object" && o.nodeType && o.outerHTML ? o.outerHTML : o && typeof o === "object" && o.nodeType === 3 && o.data ? o.data : o);
        }
      ...
      isReact: function (o) {
        ...
        try {
          if (o && typeof o === "object" && !o.nodeType && !o.appendChild && (React && React.isValidElement(o) || ReactDOM && ReactDOM.findDOMNode(o))) return true;
        } catch (e) {}

        return false;
      },
      isChain: function (o) {
        return o && typeof o === "object" && o.isClonedAccDCObject ? true : false;
      },
      isDC: function (o) {
        return o && typeof o === "object" && o.fn && o.fn.isAccDCObject ? true : false;
      },
      hasDC: function (o) {
        if (this.isClonedAccDCObject) {
          o = this.currentObject;
        ...
        return $A.isDC(o) || $A.isReact(o) && $A.isDC(o.props && o.props.DC) || $A.reg.has(o);
      },
      _isMorphedDC: function (o) {
        ...
        return o && typeof o === "object" && o.fn && o.fn.isAccDCObject && o.fn.isMorphedAccDCObject ? true : false;
      },
      isHTML: function (s) {
        if (this.isClonedAccDCObject) {
          s = this.currentObject;
      ...
      _checkStoredNodes: function (f, rNode) {
        if ($A.isChain(f)) {
          ...
          if (nl && nl.length) {
            if (rNode) return nl[0];else return nl;
          }
        } else if ($A.isReact(f)) {
          return $A.getNode(f);
        }
      ...
      loop: function (o, fn, type) {
        ...
        if ((!type || type === "map") && $A._isMap(o) && typeof o.forEach === "function") {
      ...
      isArray: function (v) {
        ...
        var o = typeof v === "object" && typeof v.length === "number" && !v.propertyIsEnumerable("length");
        return o;
      },
      ...
      query: function (sel, con, call) {
        ...
        if (!sel) {
          ...
          r.push(sel);
        } else if (!sel.nodeType && $A.isArray(sel) || typeof sel === "object") {
          r = sel;
      ...
      find: function (id, fn) {
        ...
        $A.loop($A.reg, function (k, v) {
          if (ids.length === 1 && ids[0] === "*" || ids.length && $A.inArray(k, ids) !== -1 || k === id || typeof id === "function" && id(k)) {
            fn.call(v, v);
            dcs.push(v);
          }
        }, "map");
      ...
      get: function (o) {
        ...
        */
        var config = {
          ...
          $A.fetch(url, options).then(function (response) {
            if (response.status >= 200 && response.status < 300) {
              // text or html or xml
              if (["html", "text", "xml"].indexOf(options.returnType.toLowerCase()) >= 0) response.text().then(function (content) {
                if (typeof content === "string" && options.returnType.toLowerCase() === "xml") content = $A.toXML(content);else if (typeof content === "string" && options.returnType.toLowerCase() === "html") content = $A.toNode(content);
                if (options.selector) content = $A.query(options.selector, content)[0];
                if (typeof success === "function") success.call(this, content, response);
                i++;
                if (o[i]) load(o[i].url, o[i].data, o[i].success, o[i].error);
              }); // json
              else if (options.returnType.toLowerCase() === "json") response.json().then(function (json) {
                  if (typeof success === "function") success.call(this, json, response);
                  i++;
                  if (o[i]) load(o[i].url, o[i].data, o[i].success, o[i].error);
                });
            ...
            if (typeof error === "function") error.call(this, errorMsg, this);
          });
        };
      ...
      getScript: function (source, callback, disableAsync) {
        ...
        $A.loop(urls, function (i, u) {
          Cache[u].onLoad(() => {
            if (callback && typeof callback === "function") callback.apply(window, [source, $A]);
          });
        }, "array");
      },
      ...
      load: function (target, context, data, cb, errorCB) {
        ...
        $A.get({
          ...
          error: function (errorMsg, promise) {
            if (typeof errorCB === "function") errorCB.call(this, errorMsg, promise);
          }
        });
      ...
      on: function (ta, e, fn, save, ns) {
        ...
        $A.loop(obj, function (i, o) {
          if (typeof o === "object" && o.nodeType === 1) {
            if (save) $A.data(o, "SavedEventParameters", save);
            $A.loop(events, function (j, p) {
              if (typeof j === "string" && typeof p === "function") {
                j = j.split(/\s+/);
                $A.loop(j, function (k, q) {
                  $A.listener.on(o, q + ns, function (ev) {
                    p.call(o, ev, $A.data(o, "DC"), $A.data(o, "SavedEventParameters"));
                  });
                }, "array");
              } else if (typeof p === "string" && typeof fn === "function") $A.listener.on(o, p + ns, function (ev) {
                fn.call(o, ev, $A.data(o, "DC"), $A.data(o, "SavedEventParameters"));
              });
      ...
      removeData: function (obj, key) {
        ...
        if (obj && key) {
          if ($A._dataMap.has(obj) && $A._dataMap.get(obj).has(key)) $A._dataMap.get(obj).delete(key);
        } else if (obj) {
      ...
      _insertBefore: function (obj, existingNode, fn) {
        ...
        if (!existingNode || !obj) return this.isClonedAccDCObject ? this : obj;
      ...
      _insertAfter: function (obj, existingNode, fn) {
        ...
        if (ns) ns.parentNode.insertBefore(obj, ns);else existingNode.parentNode.appendChild(obj);
        if (fn && typeof fn === "function") fn.apply(obj, [obj]);
      ...
      prepend: function (obj, root, fn) {
        ...
        if (root.nodeType && root.appendChild) {
          ...
          if (fc) $A._insertBefore(obj, fc);else root.appendChild(obj);
        }
      ...
      insertHTML: function (obj, root, pos, fn) {
        ...
        if (root && root.nodeType && root.appendChild) {
          ...
          if (typeof obj === "string") {
            ...
            if (locale[pos]) root.insertAdjacentHTML(locale[pos], obj);else root.innerHTML = obj;
          }
        }
      ...
      _clean: function (obj, sD) {
        ...
        if (!sD && $A.data(obj, "onRemoveSet")) $A.trigger(obj, "accdcremovenode");
        $A.removeData(obj);
        $A.listener.off(obj);
      },
      onRemove: function (obj, fn, save) {
        ...
        $A.on(obj, "accdcremovenode", function (ev, dc) {
          if (typeof fn === "function") fn.call(this, ev, dc, $A.data(obj, "onRemoveParameters"));
        });
      ...
      destroy: function (id, p) {
        var r = null;
        if ($A.isDC(id)) r = id;else r = $A.reg.get(id);
      ...
      mount: function (obj, root, fn) {
        ...
        if (root) {
          if (ReactDOM && ReactHtmlParser) {
            if (typeof obj === "string" || obj.nodeType) obj = $A.toReact(obj);
      ...
      getEl: function (e, mode, context, fn) {
        ...
        if (mode && typeof mode !== "number" && typeof mode === "object" && mode.querySelectorAll) {
          context = mode;
          mode = null;
        }
        ...
        // Or ./menu.html .menuClass
            ...
            $A.get({
              ...
              success: function (node) {
                if (context && context.nodeType === 1 && context.appendChild) $A.insert(node, context, fn);else if (typeof fn === "function") fn.call(node, node);
              }
            });
      ...
      createText: function (s) {
        if (s && typeof s === "object" && s.nodeType === 3) return s;else if (typeof s !== "string") s = "";
        ...
        for (var x = 0; x < o.length; x++) {
          if (o[x] && o[x].nodeType === 1 && o[x].setAttribute) {
            if (typeof name === "string") {
              if (value === null) o[x].removeAttribute(name);else o[x].setAttribute(name, value);
            } else if (typeof name === "object") {
              for (var n in name) {
                if (name[n] === null) o[x].removeAttribute(n);else o[x].setAttribute(n, name[n]);
              }
            }
          }
        }
      ...
      prevSibling: function (e, t) {
        ...
        while (e) {
          if (e.nodeType === 1 && (!t || t && typeof t === "function" && t(e))) break;
          e = e.previousSibling;
        }
      ...
      closestParent: function (node, fn) {
        ...
        while (node && node.nodeType === 1) {
          ...
          if (!fn && node.nodeType === 1 || typeof fn === "function" && fn(node)) {
            if (this.isClonedAccDCObject) {
      ...
      css: function (ob, p, v) {
        ...
        if (obj && obj[0] && obj.length === 1 && obj[0].nodeType === 1 && typeof p === "string" && typeof v !== "string" && typeof v !== "number" && !v) {
        ...
        for (var z = 0; z < obj.length; z++) {
          if (obj[z] && obj[z].nodeType === 1) {
            if (typeof p === "string") setProp(obj[z], p, v);else if (typeof p === "object") $A.loop(p, function (n, v) {
              setProp(obj[z], n, v);
            }, "object");
          }
        }
      ...
      hasClass: function (O, cn) {
        ...
        if (!o || o.nodeType !== 1 || !o.className || !cn || typeof cn !== "string") return false;
      ...
      addClass: function (obj, cn) {
        ...
        if (!obj || !cn || typeof cn !== "string") return this.isClonedAccDCObject ? this : obj;
      ...
      remClass: function (obj, cn) {
        ...
        if (!obj || !obj.className || !cn || typeof cn !== "string") return this.isClonedAccDCObject ? this : obj;
        obj = $A._stringToNode(obj);
      ...
      toggleClass: function (obj, cn, isTrue, fn) {
        ...
        for (var x = 0; x < O.length; x++) {
          ...
          try {
            ...
            if (isTrue) $A.addClass(o, cn);else $A.remClass(o, cn);
          }
      ...
      _calcPosition: function (dc, objArg, posVal) {
        ...
        if (obj && typeof obj === "string") obj = $A.query(obj)[0];else if (!obj) obj = dc.triggerObj;
        if (!obj) return;
        ...
        if (position === "absolute" && $A.css(obj, "position") !== "fixed") oPos = $A._offset(obj, true);
        ...
        if (typeof dc.offsetTop === "number" && (dc.offsetTop < 0 || dc.offsetTop > 0)) pos.top += dc.offsetTop;
        if (typeof dc.offsetLeft === "number" && (dc.offsetLeft < 0 || dc.offsetLeft > 0)) pos.left += dc.offsetLeft;
      ...
      _offset: function (c, forceAbsolute, forceRelative, returnTopLeftOnly) {
        ...
        if (forceAbsolute || position === "absolute") r = $A._getAbsolutePos(c);else if (forceRelative || position === "relative") {
          r.top = c.offsetTop;
          r.left = c.offsetLeft;
      ...
      _getComputedStyle: function (e, p, i) {
        ...
        } else if (e.currentStyle) v = e.currentStyle[$A._camelize(p)];else return null;
      ...
      addIdRef: function (obj, attr, ids) {
        ...
        if (!obj || !attr || !ids || typeof ids !== "string") return this.isClonedAccDCObject ? this : obj;

        var t = $A._stringToNode(obj);

        var o = $A._checkStoredNodes(t, true);

        $A.loop(o, function (i, o) {
      ...
      RovingTabIndex: function (options) {
        ...
        */
        ...
        that.orientation = options.orientation && options.orientation >= 0 && options.orientation <= 2 ? options.orientation : 0;
        that.index = options.startIndex && options.startIndex >= 0 ? options.startIndex : 0;
        that.parent = options.parent && options.parent.nodes && options.parent.nodes.length ? options.parent : false;
        that.children = new Map();
        that.triggeringElement = options.triggeringElement && options.triggeringElement.nodeType === 1 ? options.triggeringElement : false;
        that.autoLoop = options.autoLoop || false;
        var handlers = ["Click", "Enter", "Open", "Close", "Bounds", "Space", "CtrlSpace", "Focus", "CtrlEnd", "CtrlHome", "Esc", "Delete", "CtrlPageUp", "AltPageUp", "PageUp", "CtrlPageDown", "AltPageDown", "PageDown"];
        $A.loop(handlers, function (i, n) {
          that["handle" + n] = options["on" + n];
        }, "array");
        if (that.parent && that.triggeringElement) that.parent.children.set(that.triggeringElement, that);
        that.dc = options.dc || false;

        if (options.breakPoint && (options.breakPoint.horizontal > 1 || options.breakPoint.vertical > 1)) {
          that.breakPoint = {
            horizontal: options.breakPoint.horizontal > 1 ? options.breakPoint.horizontal : 0,
            vertical: options.breakPoint.vertical > 1 ? options.breakPoint.vertical : 0,
        ...
        that.activate = function (o) {
          var i = 0;
          if (typeof o === "number") i = that.nodes[o] ? o : 0;else i = $A.inArray(o, that.nodes) || 0;
        ...
        that.on = that.bind = function () {
          var grid = [],
              ...
              max = 0,
              keyReset = null,
              map = new Map(); // Prevent duplicate bindings

          that.off();
          $A.loop(that.nodes, function (i, o) {
            $A.data(o, "RTI", that);
            ...
            $A.on(o, {
              click: function (ev, dc) {
                ...
                if (that.handleClick && typeof that.handleClick === "function") that.handleClick.apply(o, [ev, o, that, child]);
                if (that.handleOpen && typeof that.handleOpen === "function") that.handleOpen.apply(o, [ev, o, that, child, false]);
                ev.stopPropagation();
                ev.preventDefault();
              },
              keydown: function (ev, dc) {
                ...
                var k = ev.which || ev.keyCode,
                    oMap = map.get(o),
                    child = null;
                that.boundDC = dc; // 37 left, 38 up, 39 right, 40 down, 35 end, 36 home

                if (k >= 35 && k <= 40 && !pressed.alt && !pressed.ctrl && !pressed.shift) {
                  var x = that.index,
                      pass = false;

                  if (k === 39 && that.orientation === 2 || k === 40 && that.orientation === 1) {
                    child = that.children.get(o);
                    if (that.handleOpen && typeof that.handleOpen === "function") that.handleOpen.apply(o, [ev, o, that, child, true]);
                    pass = true;
                  } else if (k === 37 && that.orientation === 2 || k === 38 && that.orientation === 1) {
                    if (that.handleClose && typeof that.handleClose === "function") that.handleClose.apply(o, [ev, o, that, that.parent, that.triggeringElement, true]);
                    pass = true;
                  } else if (k === 37 && (that.orientation === 0 || that.orientation === 1) || k === 38 && (that.orientation === 0 || that.orientation === 2)) {
                    if (that.breakPoint) {
                      if (that.breakPoint.horizontal && k === 37 && (that.orientation === 0 || that.orientation === 1)) {
                        if (oMap.x > 0 || oMap.x === 0 && oMap.y > 0 && !that.breakPoint.horizontalStop) that.index--;else if (oMap.x === 0 && oMap.y === 0 && that.handleBounds && typeof that.handleBounds === "function") that.handleBounds.apply(o, [ev, o, that, k]);
                      } else if (that.breakPoint.vertical && k === 38 && (that.orientation === 0 || that.orientation === 2)) {
                        if (oMap.y > 0) that.index = map[grid[oMap.y - 1][oMap.x]].i;else if (oMap.y === 0 && that.handleBounds && typeof that.handleBounds === "function") that.handleBounds.apply(o, [ev, o, that, k]);
                      }
                    } else that.index = that.index === 0 ? that.autoLoop ? that.nodes.length - 1 : x : that.index - 1;
                  } else if (k === 39 && (that.orientation === 0 || that.orientation === 1) || k === 40 && (that.orientation === 0 || that.orientation === 2)) {
                    if (that.breakPoint) {
                      if (that.breakPoint.horizontal && k === 39 && (that.orientation === 0 || that.orientation === 1)) {
                        if (oMap.x < that.breakPoint.horizontal || oMap.x === that.breakPoint.horizontal && oMap.y < max && !that.breakPoint.horizontalStop) that.index++;else if (oMap.x === that.breakPoint.horizontal && oMap.y === max && that.handleBounds && typeof that.handleBounds === "function") that.handleBounds.apply(o, [ev, o, that, k]);
                      } else if (that.breakPoint.vertical && k === 40 && (that.orientation === 0 || that.orientation === 2)) {
                        if (oMap.y < max) that.index = map[grid[oMap.y + 1][oMap.x]].i;else if (oMap.y === max && that.handleBounds && typeof that.handleBounds === "function") that.handleBounds.apply(o, [ev, o, that, k]);
                      }
                    } else that.index = that.index === that.nodes.length - 1 ? that.autoLoop ? 0 : x : that.index + 1;
                  } else if (k === 35) {
                    if (that.breakPoint && that.breakPoint.horizontal > 0 && oMap.x < that.breakPoint.horizontal) that.index = map[grid[oMap.y][that.breakPoint.horizontal]].i;else that.index = that.nodes.length - 1;
                  } else if (k === 36) {
                    if (that.breakPoint && that.breakPoint.horizontal > 0 && oMap.x > 0) that.index = map[grid[oMap.y][0]].i;else that.index = 0;
                  }

                  if (!pass && that.index !== x) that.setFocus.apply(that.nodes[that.index], [ev, that]);
                  ev.stopPropagation();
                  ev.preventDefault();
                } else if ((k === 35 || k === 36) && !pressed.alt && pressed.ctrl && !pressed.shift) {
                  if (k === 35) {
                    if (that.handleCtrlEnd && typeof that.handleCtrlEnd === "function") {
                      that.handleCtrlEnd.apply(o, [ev, o, that]);
                    }
                  } else if (k === 36) {
                    if (that.handleCtrlHome && typeof that.handleCtrlHome === "function") {
                  ...
                  ev.stopPropagation();
                  ev.preventDefault();
                } else if (k === 27 && !pressed.alt && !pressed.ctrl && !pressed.shift) {
                  if (that.handleEsc && typeof that.handleEsc === "function") {
                    that.handleEsc.apply(o, [ev, o, that, that.parent, that.triggeringElement]);
                    ev.stopPropagation();
                    ev.preventDefault();
                  }

                  if (that.handleClose && typeof that.handleClose === "function") {
                    that.handleClose.apply(o, [ev, o, that, that.parent, that.triggeringElement, false]);
                    ev.stopPropagation();
                    ev.preventDefault();
                  }
                } else if (k === 46 && !pressed.alt && !pressed.ctrl && !pressed.shift) {
                  if (that.handleDelete && typeof that.handleDelete === "function") {
                  ...
                  if (k === 33) {
                    if (!pressed.alt && pressed.ctrl && !pressed.shift) {
                      if (that.handleCtrlPageUp && typeof that.handleCtrlPageUp === "function") {
                        that.handleCtrlPageUp.apply(o, [ev, o, that]);
                        ev.stopPropagation();
                        ev.preventDefault();
                      }
                    } else if (pressed.alt && !pressed.ctrl && !pressed.shift) {
                      if (that.handleAltPageUp && typeof that.handleAltPageUp === "function") {
                        that.handleAltPageUp.apply(o, [ev, o, that]);
                        ev.stopPropagation();
                        ev.preventDefault();
                      }
                    } else if (!pressed.alt && !pressed.ctrl && !pressed.shift) {
                      if (that.handlePageUp && typeof that.handlePageUp === "function") {
                    ...
                    if (!pressed.alt && pressed.ctrl && !pressed.shift) {
                      if (that.handleCtrlPageDown && typeof that.handleCtrlPageDown === "function") {
                        that.handleCtrlPageDown.apply(o, [ev, o, that]);
                        ev.stopPropagation();
                        ev.preventDefault();
                      }
                    } else if (pressed.alt && !pressed.ctrl && !pressed.shift) {
                      if (that.handleAltPageDown && typeof that.handleAltPageDown === "function") {
                        that.handleAltPageDown.apply(o, [ev, o, that]);
                        ev.stopPropagation();
                        ev.preventDefault();
                      }
                    } else if (!pressed.alt && !pressed.ctrl && !pressed.shift) {
                      if (that.handlePageDown && typeof that.handlePageDown === "function") {
                  ...
                  if (k === 13) {
                    child = that.children.get(o);
                    if (that.handleEnter && typeof that.handleEnter === "function") that.handleEnter.apply(o, [ev, o, that, child]);
                    if (that.handleOpen && typeof that.handleOpen === "function") that.handleOpen.apply(o, [ev, o, that, child, false]);
                    ev.stopPropagation();
                    ev.preventDefault();
                  } else if (k === 32) {
                    if (!pressed.ctrl) {
                      if (that.handleSpace && typeof that.handleSpace === "function") {
                        that.handleSpace.apply(o, [ev, o, that, child]);
                        ev.stopPropagation();
                        ev.preventDefault();
                      }
                    } else {
                      if (that.handleCtrlSpace && typeof that.handleCtrlSpace === "function") {
                ...
                } else if ((k >= 48 && k <= 57 || k >= 65 && k <= 90) && !pressed.alt && !pressed.ctrl && !pressed.shift) {
                  ...
                  var move = function () {
                    if (that.lastTyped === k) that.typed = String.fromCharCode(k);else that.typed += String.fromCharCode(k);
                    var b = 0,
                        i = that.index += 1,
              ...
              focus: function (ev, dc) {
                that.boundDC = dc;
                if (that.handleFocus && typeof that.handleFocus === "function") that.handleFocus.apply(o, [ev, o, that]);
              }
            });
            $A.setAttr(o, {
      ...
      focus: function (obj) {
        ...
        if (!obj || obj.nodeType !== 1) return this.isClonedAccDCObject ? this : obj;
      ...
      isFocusable: function (node, usingFocus) {
        ...
        if (usingFocus && typeof tabI === "number" || !usingFocus && typeof tabI === "number" && tabI >= 0) {
          return true;
        }
        ...
        if (["button", "input", "select", "textarea"].indexOf(nodeName) !== -1 && $A.getAttr(node, "type") !== "hidden") {
          return true;
        }
    ...
    (function (global) {
      ...
      $A.ScriptCache = function (config) {
        var scripts = new Map();
        $A.loop(config.scripts, function (i, url) {
          scripts[url] = url;
        }, "array");
        const Cache = {};
        ...
        Cache._scriptTag = (key, src) => {
          if (!scriptMap.has(key)) {
            ...
            var promise = new Promise((resolve, reject) => {
              ...
              var handleResult = state => {
                return evt => {
                  ...
                  if (state === "loaded") {
                    ...
                    resolve(src); // stored.handlers.loop(h => h.call(null, stored))
                    // stored.handlers = []
                  } else if (state === "error") {
                    stored.errored = true; // stored.handlers.loop(h => h.call(null, stored))
                    // stored.handlers = [];
              ...
              (config.context || document.head || document.body).appendChild(tag);
              return tag;
            });
            var initialState = {
              loaded: false,
      ...
      if (str && typeof str === "string") {
        var uA = function () {
          if (stringAnnounce.loaded) {
            if (!stringAnnounce.liveRendered && !aggr && stringAnnounce.placeHolder) {
              stringAnnounce.liveRendered = true;
              document.body.appendChild(stringAnnounce.placeHolder);
            }

            if (!stringAnnounce.alertRendered && aggr && stringAnnounce.placeHolder2) {
              stringAnnounce.alertRendered = true;
              document.body.appendChild(stringAnnounce.placeHolder2);
            }
          }

          if (!loop && $A.inArray(str, stringAnnounce.alertMsgs) === -1) stringAnnounce.alertMsgs.push(str);

          if (stringAnnounce.alertMsgs.length === 1 || loop) {
            var timeLength = stringAnnounce.baseDelay + stringAnnounce.iterate(stringAnnounce.alertMsgs[0], /\s|,|\.|:|;|!|\(|\)|\/|\?|@|#|\$|%|\^|&|\*|\\|-|_|\+|=/g) * stringAnnounce.charMultiplier;

            if (!(noRep && stringAnnounce.lastMsg === stringAnnounce.alertMsgs[0])) {
              stringAnnounce.lastMsg = stringAnnounce.alertMsgs[0];
              if (aggr) $A.insertHTML(stringAnnounce.alertMsgs[0], stringAnnounce.placeHolder2);else $A.insertHTML(stringAnnounce.alertMsgs[0], stringAnnounce.placeHolder);
            }
            ...
            stringAnnounce.alertTO = setTimeout(function () {
              ...
              if (stringAnnounce.alertMsgs.length >= 1) announceString(stringAnnounce.alertMsgs[0], noRep, aggr, true);
            }, timeLength);
          }
        };

        if (!$A.documentLoaded) window.addEventListener("load", function () {
          uA();
        });else uA();
      }
    ...
    window.addEventListener("load", function () {
      ...
      if (!stringAnnounce.placeHolder) {
        stringAnnounce.placeHolder = $A.createEl("div", {
          "aria-live": "polite"
        }, $A.sraCSS);
        stringAnnounce.placeHolder2 = $A.createEl("div", {
          role: "alert"
        }, $A.sraCSS);
      }
    ...
    var GenAccDC = function (AccDCObjects, gImport, parentDC) {
      var wheel = [],
        ...
        if ((dc.isTab || dc.isToggle) && dc.toggleClassName) {
          if (isClose && (dc.trigger || dc.triggerObj)) {
            ...
            $A.query(dc.trigger || dc.triggerObj, function (i, o) {
              $A.toggleClass(o, dc.toggleClassName, this === dc.triggerObj ? dc.loaded : false);
            });
          }
        }
        ...
        if (!dc[ranJSOnce]) {
          ...
          if (dc.reverseJSOrder) {
            ...
            if (dc.allowCascade) {
              if (dc.fn.proto[runOnce]) dc.fn.proto[runOnce].apply(dc, [dc]);
              if ($A.fn.globalDC[runOnce]) $A.fn.globalDC[runOnce].apply(dc, [dc]);
            }
          ...
          if (dc.allowCascade) {
            ...
            if ($A.fn.globalDC[runJSOnce] && $A.fn.globalDC[runJSOnce].length) {
        ...
        if (dc.widgetType && $A._widgetTypes.length) {
          for (w = 0; w < $A._widgetTypes.length; w++) {
            ...
            if (wt && wt.autoCloseWidget && wt.loaded && wt.widgetType !== dc.widgetType) {
              wt.fn.bypass = true;
              wt.close();
              wt.fn.bypass = false;
            }
        ...
        if (dc.widgetType && dc.autoCloseSameWidget && $A._regWidgets.has(dc.widgetType)) {
        ...
        dc.fn.closeLink = $A.createEl("a", {
          id: dc.closeId,
          href: "#close"
        }, $A.sraCSS, dc.closeClassName);
        ...
        if (ReactDOM && ReactHtmlParser && dc.source && dc.RenderUsingReact && !dc.mode) {
        ...
        if (ReactDOM && dc.React.component) {
          ...
          switch (dc.mode) {
            case 1:
              $A.load(dc.source || dc.fetch.url, dc.container, dc.fetch.data, function (content, promise) {
            ...
            case 2:
              $A.get({
                ...
                success: function (content, promise) {
                  ...
                  if (dc.sourceOnly) {
                    dc.outerNode = dc.container = $A.toNode(dc.content, true);
                  } else {
        ...
        if (dc.outerNode && dc.container) {
          ...
          if (dc.displayInline) $A.css([dc.outerNode, dc.container], "display", "inline");
        ...
        if (dc.outerNode && dc.container) {
          if ($A._isMorphedDC(dc)) {
            ...
            if (dc.source && dc.source.nodeType === 1 && dc.source.parentNode && dc.source.parentNode.nodeType === 1 && !dc.root && !dc.triggerObj && !dc.targetObj) {
            ...
            if (dc.before) {
              if (typeof dc.before === "function") dc.before.apply(dc, [dc.outerNode, dc.root]);else $A.before(dc.outerNode, dc.root);
            } else if (dc.prepend) {
              if (typeof dc.prepend === "function") dc.prepend.apply(dc, [dc.outerNode, dc.root]);else {
                try {
              ...
              if (typeof dc.append === "function") dc.append.apply(dc, [dc.outerNode, dc.root]);else {
                try {
              ...
              if (typeof dc.after === "function") dc.after.apply(dc, [dc.outerNode, dc.root]);else $A.after(dc.outerNode, dc.root);
            } else {
              $A.insert(dc.outerNode, dc.root);
            }
          } else if (dc.targetObj) $A._insertAfter(dc.outerNode, dc.targetObj);else if (dc.triggerObj) $A._insertAfter(dc.outerNode, dc.triggerObj);
        }
        ...
        var complete = function () {
          ...
          if (dc.exposeHiddenClose) {
            ...
            if (dc.displayHiddenClose) $A.on(dc.fn.closeLink, {
              focus: function (ev) {
          ...
          for (var ev in events) {
            if (dc[ev] && typeof dc[ev] === "function") toBind[ev.toLowerCase()] = events[ev];
          }
          ...
          if (dc.timeoutVal) dc.timer = setTimeout(function () {
            dc.timeout(dc);
          }, dc.timeoutVal);
          ...
          if (ReactDOM && dc.React.component && dc.React.component.forceUpdate) {
        ...
        $A.loop(cFocus, function (k, v) {
          if ($A.inArray("focus", k) === 0) dc.fn.containsFocus = true;else if ($A.inArray("click", k) >= 0) isOnClick = true;
        }, "object");
        ...
        if (dc.trigger) $A.query(dc.trigger, function (i, o) {
          if (!$A.data(o, "DC-ON")) {
            $A.data(o, "DC", dc);
            $A.data(o, "DC-ON", true);
          }
          ...
          if (dc.on && typeof dc.on === "string") {
            if (!dc.suppressClickSupport && isOnClick && !$A.isFocusable(o)) {
        ...
        if (React && nDC.React.component) {
          ...
          if (nDC.React.parent && nDC.React.parent.props && $A.isDC(nDC.React.parent.props.DC)) {
        ...
        if (nDC.widgetType && nDC.autoCloseSameWidget) {
          if (!$A._regWidgets.has(nDC.widgetType)) $A._regWidgets.set(nDC.widgetType, []);
      ...
      for (a = 0; a < AccDCObjects.length; a++) {
        var dc = {
          ...
          getOffset: function (forceAbsolute, forceRelative, returnTopLeftOnly) {
            var dc = this;
            return $A.getOffset(dc.outerNode, forceAbsolute, forceRelative, returnTopLeftOnly);
          },
          trigger: "",
          setTrigger: function (dc) {
            var dc = dc || this;
          ...
          */
          ...
          map: function (o, extend) {
            ...
            if ($A.isArray(o.children)) {
              ...
              for (var i = 0; i < o.children.length; i++) {
                if ($A.isDC(o.children[i])) {
                  ...
                  if (!inList(o.children[i], dc.children)) dc.children.push(o.children[i]);
                }
              }
            }
            ...
            if ($A.isArray(o.siblings)) {
              ...
              for (var i = 0; i < o.siblings.length; i++) {
                if ($A.isDC(o.siblings[i])) {
                  if (!inList(o.siblings[i], dc.siblings)) dc.siblings.push(o.siblings[i]);
                }
              }
            }
            ...
            while ($A.isDC(p) && (!dc.widgetType || dc.widgetType === p.widgetType)) {
              dc.top = p;
              p = p.parent;
            }

            if (dc.parent && !extend) dc.parent.children = [];
            $A.loop(dc.siblings, function (x, DC) {
              if ($A.isDC(DC)) {
                DC.parent = dc.parent;
                DC.siblings = dc.siblings;
                if (dc.parent && !inList(DC, dc.parent.children)) dc.parent.children.push(DC);
              }
            }, "array");
            ...
            var setTop = function (a) {
              for (var i = 0; i < a.length; i++) {
                if ($A.isDC(a[i]) && a[i].children.length) {
                  $A.loop(a[i].children, function (x, DC) {
                    if ($A.isDC(DC)) {
                      setTop(DC.siblings);
                    }
                  }, "array");
        ...
        if (typeof aO.allowCascade !== "boolean") {
          if (typeof gImport.allowCascade === "boolean") aO.allowCascade = gImport.allowCascade;else if (typeof $A.fn.globalDC.allowCascade === "boolean") aO.allowCascade = $A.fn.globalDC.allowCascade;else aO.allowCascade = false;
        }
        ...
        if (dc.id) {
          ...
          if ($A.isDC(DC)) {
            ...
            if ($A.isDC(parentDC)) {
              ...
              if (chk >= 0) p.children.slice(chk, 1, c);else p.children.push(c);
              c.parent = p;
              var t = c;
