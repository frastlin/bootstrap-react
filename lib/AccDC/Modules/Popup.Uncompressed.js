    ...
    setPopup: function (overrides) {
      ...
      var config = {
        ...
        keyDown: function (ev, dc) {
          var k = ev.which || ev.keyCode; // If Escape is pressed, close the popup
      ...
      $A([config], overrides.overrides || {}); // Return the new popup AccDC Object ID
...
//# sourceMappingURL=Popup.Uncompressed.js.map