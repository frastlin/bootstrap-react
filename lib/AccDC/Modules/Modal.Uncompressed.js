    ...
    setModal: function (overrides) {
      ...
      var config = {
        ...
        runDuring: function (dc) {
          ...
          $A.addClass(dc.container, overrides.containerClassName || "container");
        ...
        runAfterClose: function (dc) {
          ...
          if ($A.setModal.openModals.length) {
            $A.setModal.openModals[$A.setModal.openModals.length - 1].remAttr("aria-hidden");
          } else {
        ...
        reposition: function (callbackFn) {
          ...
          if ($A.setModal.openModals[$A.setModal.openModals.length - 1].autoFix) $A.setModal.openModals[$A.setModal.openModals.length - 1].applyFix();else if ($A.setModal.openModals[$A.setModal.openModals.length - 1].autoPosition) $A.setModal.openModals[$A.setModal.openModals.length - 1].setPosition(); // Run custom specified function?

          if (typeof callbackFn === "function") {
            callbackFn($A.setModal.openModals[$A.setModal.openModals.length - 1]);
          }

          return true;
        },
        keyDown: function (ev, dc) {
          var k = ev.which || ev.keyCode; // If Escape is pressed, close the modal
      ...
      $A([config], overrides.overrides || {}, true); // Return the new modal AccDC Object ID
...
//# sourceMappingURL=Modal.Uncompressed.js.map