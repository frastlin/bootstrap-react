  ...
  if (!("setAccordion" in $A)) $A.extend({
    setAccordion: function (selector, overrides, context, callback, config) {
      ...
      $A.query(selector, context, function (i, o) {
        ...
        if (namedRegion && overrides.regions && overrides.regions[namedRegion]) {
          ovrs.React = {
            name: namedRegion,
        ...
        if (!$A.isFocusable(o)) $A.setAttr(o, {
          tabindex: "0"
        });
      });
...
//# sourceMappingURL=Accordion.Uncompressed.js.map