  ...
  if (!("setTabs" in $A)) $A.extend({
    setTabs: function (tabs, overrides, tabList, callback) {
      ...
      $A.loop(tabs, function (i, o) {
        ...
        var ovrs = {
          ...
          runAfter: function (dc) {
            ...
            $A.loop(tabs, function (j, tab) {
              $A.setAttr(tab, {
                "aria-selected": tab === dc.triggerObj ? "true" : "false",
                "aria-expanded": tab === dc.triggerObj ? "true" : "false"
              });
            }, "array");
            if (callback && typeof callback === "function") callback.apply(dc.triggerObj, [dc, dc.loaded]);
        ...
        if (controls && overrides.tabPanels && overrides.tabPanels[controls]) {
          ovrs.React = {
            name: controls,
      ...
      if (tabs.length) {
        updateDisabled(tabs);
        var orientation = 0;
        if (ariaOrientation === "horizontal") orientation = 1;else if (ariaOrientation === "vertical") orientation = 2;
        RTI = new $A.RovingTabIndex({
          container: tabList,
          nodes: tabs,
          orientation: orientation,
          autoLoop: true,
          onOpen: function (ev, tabNode, RTI, childRTI, wasTriggeredWithArrowKey) {
...
//# sourceMappingURL=Tabs.Uncompressed.js.map