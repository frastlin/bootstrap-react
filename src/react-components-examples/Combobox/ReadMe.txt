...
To enable multiselect functionality, add the attribute multiple="multiple" to the hidden select element.

<select hidden name="control-name">
...
myCombobox = setCombobox(ReactComponentObject, {
      input: "#idForEditField", // CSS selector or DOM node
      select: "#idForHiddenSelect", // CSS selector or DOM node
      overrides: {
        role: "ShortFieldTypeName",
                // DC.outerNode className
        className: "",
                // DC.container className
        middleClass: "",
                // Dynamic listbox element className
        listboxClass: "",
                // Dynamic listbox option elements className
        optionClass: "",
                // Selected listbox option element className
        activeClass: "",
                // Toggle element className when dropdown is expanded
        toggleClass: ""
      }
    });
...
// For details, see Help/DC API/DC Object Properties and Methods/CSS Methods/SetPosition.txt
